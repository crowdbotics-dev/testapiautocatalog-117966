...
## Project Structure
    ...
    ├── testapiautocatalog_117966  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_117966`
...
2. Clone this repo and `cd testapiautocatalog_117966`
